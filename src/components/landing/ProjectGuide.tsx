...
const topics = [
  ...
  { label: "POS Workflow", icon: CreditCard },
  { label: "Kitchen Receipt Printing", icon: Printer },
  { label: "Admin Dashboard", icon: LayoutDashboard },
  { label: "Multi-tenant SaaS Architecture", icon: Building2 },
  { label: "Business Requirements", icon: Rocket },
      ...
      <div className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/[0.08] via-white/[0.035] to-amber-400/[0.08] p-6 shadow-2xl shadow-black/30 backdrop-blur-xl transition-colors hover:border-amber-400/30 sm:p-8 lg:p-10">
        ...
        <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] lg:items-center">
          <div>
            ...
            >
              Want to see how everything works before trying the demo? Read a
              guided product walkthrough built for cafe owners, clients, and
              technical reviewers.
            </motion.p>
            ...
            <div className="mt-6 rounded-2xl border border-amber-300/20 bg-amber-300/10 p-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm leading-relaxed text-zinc-300">
                  A visual guide covering product flow, tenant architecture,
                  business setup, security, deployment, and roadmap.
                </p>
              </div>
            </div>
          </motion.div>
